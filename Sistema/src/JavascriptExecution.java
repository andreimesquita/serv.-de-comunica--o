...
public class JavascriptExecution extends JPanel {
	...
	public JavascriptExecution() {
		...
		JCheckBox enableJavascriptCheckBox = new JCheckBox("Enable Javascript",
				true);
		enableJavascriptCheckBox.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				...
				// Javascript state only affects subsequent pages. Let's reload
				// the content.
				webBrowser.setHTMLContent(htmlContent);
			}
		});
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				frame.getContentPane().add(new JavascriptExecution(),
						BorderLayout.CENTER);
