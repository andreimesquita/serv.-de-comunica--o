...
public class TestCriacaoBdNuvem {
	public static void main(String[] args) throws Exception {
		String url = "jdbc:mysql://us-cdbr-cb-east-01.cleardb.net:3306/cb_servcomunicacao", login = "b9810182bba4eb", senha = "d1edb77d";
		...
		// con.prepareStatement("CREATE TABLE pessoas (id integer, nome varchar(100), PRIMARY KEY(id))");
		// ps.executeUpdate();
		...
		while (rst.next()) {
			System.out.println("1: " + rst.getInt(1) + " - 2: "
					+ rst.getString(2));
		}
