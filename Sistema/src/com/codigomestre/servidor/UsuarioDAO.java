...
public class UsuarioDAO {
	...
	public void cadastrar(Usuario u)
		...
		if (b) {
			System.out.println("ERRO CADASTRO NOME DUPLICADO EXCEPTION");
	...
	public List<Usuario> getAll() throws Exception {
		...
		while (objrs.next()) {
			a.add(new Usuario(objrs.getString(1), objrs.getString(2), objrs.getString(3)));
		}
		
		return a;
	}
	
	public boolean isOnline(Usuario u) throws SQLException, ErroDeConexaoException {
		PreparedStatement objprep = conexao.getRetornarEstadoDePreparo(SQL_ONLINE_POR_EMAIL);
		objprep.setString(1, u.getEmail());
		ResultSet objrs = objprep.executeQuery();
		objrs.next();
	...
	public void logar(Usuario u) throws SQLException, ErroDeConexaoException{
		PreparedStatement objprep = conexao.getRetornarEstadoDePreparo(SQL_SET_ONLINE);
		objprep.setString(1, u.getEmail());
