...
public class Toast implements Runnable {
	...
	public static void main(String[] args) {
		...
		System.out.println("mensagem30c: " + mensagem30cArray.length + " \\ linhas: " + linhas30c);
		System.out.println("mensagem60c: " + mensagem60cArray.length + " \\ linhas: " + linhas60c);
		System.out.println("mensagem90c: " + mensagem90cArray.length + " \\ linhas: " + linhas90c);
		System.out.println("mensagem120c: " + mensagem120cArray.length + " \\ linhas: " + linhas120c);
