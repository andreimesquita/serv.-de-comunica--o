...
public class CadastroUsuario {
	...
	public void cadastrar(Usuario u) throws ErroDuranteCadastroException,
			ErroDeConexaoException, SQLException {

		PreparedStatement objprep = conexao
				.getRetornarEstadoDePreparo(SQL_TESTE_CADASTRO_EMAIL_EXISTE);
		...
		if (b) {
			throw new ErroDuranteCadastroException(
	...
	public void reset() throws SQLException, ErroDeConexaoException {
		PreparedStatement objprep = conexao
				.getRetornarEstadoDePreparo("truncate table "
						.concat(TABELA_USUARIOS_NOME));
		objprep.execute();
	}
